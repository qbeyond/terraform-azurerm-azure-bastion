...
variable "scale_units" {
  description = "Allows scale the number of 'backend instances/VMs' between 2-50, <each unit/instance/VM allows 20 sessions>, by default is 2 (40 sessions) on Basic and Standard tier, but it can only be modified in the Standard tier"
  type        = string
  default     = "2"
}
